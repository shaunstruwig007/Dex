...
```
Dex/
├── blueprint/                  # How Dex works: guides, product-dashboard, workboard (vault root)
...
**Dex system docs and tools** live at the vault root as **`blueprint/`** (not inside `06-Resources/`): guides, **product-dashboard**, **workboard**, and this **`Folder_Structure.md`**.
...
- `blueprint/Dex_Jobs_to_Be_Done.md` — Why the system exists
- `blueprint/Dex_System_Guide.md` — How to use everything
