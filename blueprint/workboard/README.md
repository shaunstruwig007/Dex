...
**Open Product dashboard:** from vault root, e.g. `http://127.0.0.1:8766/blueprint/product-dashboard/index.html` — see [product-dashboard README](../product-dashboard/README.md).
