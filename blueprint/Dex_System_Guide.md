...
│
├── blueprint/                  # How Dex works (this documentation, product-dashboard, workboard)
│
...
**Reference:** See `blueprint/Memory_Ownership.md` for details on how agent memory works.
...
**Reference:** See `blueprint/Named_Sessions_Guide.md` for details on how named sessions work.
...
**Reference:** See `blueprint/Background_Processing_Guide.md` for details on how automated follow-ups work.
...
- `blueprint/Dex_Jobs_to_Be_Done.md` — Why the system exists (conceptual)
- `blueprint/Memory_Ownership.md` — How agent memory works across sessions
- `blueprint/Named_Sessions_Guide.md` — Context isolation and named sessions
- `blueprint/Background_Processing_Guide.md` — Automated follow-ups and background tasks
