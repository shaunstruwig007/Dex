...
6. **Skill updates:**
   ...
   - `blueprint/Dex_System_Guide.md` (if features added)
...
**Read this FIRST:** `blueprint/Pi_TUI_Reference.md`
...
- `blueprint/Dex_System_Guide.md` (user-facing guide)
- `blueprint/Dex_Jobs_to_Be_Done.md` (why each piece exists)
