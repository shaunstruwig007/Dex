...
Read plans/PDLC_UI/plan-mode-prelude.md first. Then execute Sprint S6 — Design review gate (Bar B; Bar A surfaces this as a warning nudge only). Branch: feat/s6-design-review.
...
Post-merge: Slice log line + tick S6 Progress in plan.md.
