...
- **product-dashboard/** — **Product dashboard** (Executive + orchestration swim lanes); see [product-dashboard/README.md](./product-dashboard/README.md). **workboard/** — **Tasks Kanban** (`Tasks.md` sync); see [workboard/README.md](./workboard/README.md). **Product ideas** (pre-PRD discovery markdown): [`../06-Resources/Product_ideas/README.md`](../06-Resources/Product_ideas/README.md).
