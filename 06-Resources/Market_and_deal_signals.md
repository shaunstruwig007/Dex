...
|---------|-------------|-------------------|---------------------|------------------------------|---------------------|-------|
| 2026-04-15 | Trade press + product | [IT News Africa — Jem Mobile](https://www.itnewsafrica.com/2025/10/jem-launches-mobile-service-to-cut-data-costs-for-south-africas-frontline-workers/) · [jemhr.com/jem-mobile](https://www.jemhr.com/jem-mobile/) · [Bizcommunity](https://www.bizcommunity.com/article/jem-hr-launches-new-mobile-service-for-sa-employees-515010a) | [JEM HR](./Competitors/profiles/Jem.md) | **Jem Mobile** announced **Oct 2025**: **smartphones + data contracts** via **payroll deduction** for SA **frontline** workers; employer **zero-cost / zero-upfront** narrative; networks **Vodacom, MTN, Telkom** (per product page); onboarding + device support / insurance (per press + site) | **Adoption + inclusion** play: closes **device/data gap** that limits WhatsApp HR reach; refresh battle cards — **multi-channel** (app, SMS, WA, USSD) and **access** story; not only “HR on WA” | EV-2026-04-002 |
