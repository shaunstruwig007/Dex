...
- **WhatsApp delivery** — Future phase. Phase 1 is SMS, email, and push.
...
- [ ] Respects user notification preferences (email on/off, push on/off).
### Support Integration
