...
follow_up_tasks:
  - Keep §9 WhatsApp tenant surface in sync with Messaging Part 2
---

# Tenant Management

**Status:** Done (Essential) — agent-oriented retrofit  
**Target:** Tenant Managers configuring tenant lifecycle, identifiers, branding hooks, messaging cost settings, and elevated auth  
**Estimated Effort:** Large multi-section spec — maintain per numbered sections below
...
**Related PRDs:** [Login_Account_Activation.md](./Login_Account_Activation.md) (QR, identifiers, routing), [Theming.md](./Theming.md) (login branding), [communication_service.md](./communication_service.md) (invites/OTP), [Messaging_Ops_Urgent_Alerts.md](./Messaging_Ops_Urgent_Alerts.md) (tenant currency / SMS rates), [Part 2 — WhatsApp](./Messaging_Ops_Urgent_Alerts.md#whatsapp-channel--outbound-messaging) (WhatsApp config detail — §9 below is the tenant-side surface). **Integration map:** [PRD_Product_Map.md](./PRD_Product_Map.md).

---

## The Job to Be Done

Tenant Managers can **create, configure, and operate** a tenant — QR/short codes, branding, comms cost settings, WhatsApp toggles, and **elevated auth** factors — so employees activate and use the platform under policy.

**User value:** Onboarding velocity; compliance with identity and messaging rules across Login, Messaging, Payslip.

---

## Work Packages

### WP-Onboard: Creation & QR (P0)
...
### WP-Identity: Elevated auth config (P0)

**Priority:** P0  
**Dependencies:** [Elevated_Auth_Remote_App.md](./Elevated_Auth_Remote_App.md)  
**Files:** See sections referencing elevated auth  
**VPS-eligible:** Yes

### WP-Comms: Rates / currency / WhatsApp (P0)

**Priority:** P0  
**Dependencies:** [Messaging_Ops_Urgent_Alerts.md](./Messaging_Ops_Urgent_Alerts.md)  
**Files:** §9 + Part 2 cross-links  
**VPS-eligible:** Yes

### WP-Branding: Theming hooks (P0)
...
- New tenant receives QR + short code per §1 stories.  
- WhatsApp toggle and cost settings consistent with Messaging Part 2.

---

## Satisfaction Metric

**Overall Success:** Section-by-section BDD / AC rows (where present) pass regression **≥ 95%** (target).

**Measured by:** QA per numbered area.
...
- **Eight** feature areas remain the body of truth below — do not remove numbered structure without steerco.  
- **WhatsApp** tenant surface aligns with Messaging Part 2.
...
```bash
grep -c "# 1. Tenant Creation" "06-Resources/PRDs/Tenant_Management.md"
# PASS: >= 1

grep -c "WhatsApp" "06-Resources/PRDs/Tenant_Management.md"
# PASS: >= 1
```

**Manual:** Full tenant setup walkthrough.

---

## Notes for Agent Implementation

**Scout priorities:** Cross-links to Login, Messaging, Payslip for any config drift.
...
- Features not covered in the eight areas without new steerco section.
...
**Full channel spec:** [Part 2 — WhatsApp](./Messaging_Ops_Urgent_Alerts.md#whatsapp-channel--outbound-messaging). This section covers only the tenant-management surface (the settings screens and admin controls). Message sending behaviour, opt-in flows, delivery tracking, and Meta API integration are specified in the WhatsApp PRD.
...
**Related:** [Login_Account_Activation.md](./Login_Account_Activation.md), [Theming.md](./Theming.md), [communication_service.md](./communication_service.md), [Messaging_Ops_Urgent_Alerts.md](./Messaging_Ops_Urgent_Alerts.md) (currency/rates), [Part 2 — WhatsApp](./Messaging_Ops_Urgent_Alerts.md#whatsapp-channel--outbound-messaging) (full channel spec — §9 ACs below cover tenant config surface only).
