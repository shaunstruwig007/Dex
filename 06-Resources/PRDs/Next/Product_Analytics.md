...
- [Feed.md](../Current/Feed.md) — feed engagement events (views, dwell time, reactions)
- [Posts.md](../Current/Posts.md) — post-level metrics (views, reactions, click-throughs per content type)
- [Messaging_Ops_Urgent_Alerts.md](../Current/Messaging_Ops_Urgent_Alerts.md) — message delivery and read receipts
- [Communication.md](../Current/Communication.md) — channel delivery rates (push, SMS, WhatsApp)
- [Profile_Users.md](../Current/Profile_Users.md) — user segments for cohort analytics
- [Login_Account_Activation.md](../Current/Login_Account_Activation.md) — activation funnel and session data
