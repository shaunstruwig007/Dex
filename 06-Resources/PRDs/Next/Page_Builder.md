...
- [Posts.md](../Current/Posts.md) — Posts are single-template content (Text OR Image OR Link OR PDF OR Video OR Form Link). Page Builder extends beyond the single-template limit into multi-widget composition.
- [Feed.md](../Current/Feed.md) — A Page Builder page is referenced from the Feed via a post CTA or message link; it does not appear inline in the Feed.
...
- [Messaging_Ops_Urgent_Alerts.md](../Current/Messaging_Ops_Urgent_Alerts.md) — Messages can deep-link to a Page as a CTA (e.g. "Read the full safety procedure →")
